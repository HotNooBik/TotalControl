...
class OwnFoodEntryForm(forms.Form):
    food_name = forms.CharField(
        ...
        max_length=100,
        widget=forms.TextInput(attrs={'class': 'form-control', 'id': 'name-input', 'placeholder': "Введите название продукта"})
        )
    ...
    calories = forms.FloatField(
        ...
        min_value=0,
        max_value=50000,
        widget=forms.NumberInput(attrs={'class': 'form-control', 'id': 'calories-input'})
    )
    ...
    proteins = forms.FloatField(
        ...
        min_value=0,
        max_value=50000,
        widget=forms.NumberInput(attrs={'class': 'form-control', 'id': 'proteins-input'})
    )
